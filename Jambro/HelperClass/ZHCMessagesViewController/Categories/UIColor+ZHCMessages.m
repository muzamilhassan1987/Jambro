...
+ (UIColor *)zhc_messagesBubbleBlueColor
{
    return [UIColor colorWithHue:210.0f / 360.0f
                      ...
                      brightness:1.0f
                           alpha:1.0f];
    //return [UIColor colorWithRed:(244/255.f) green:(244/255.f) blue:(244/255.f) alpha:255.f];
}
//+ (UIColor *)zhc_messagesBubbleBlueColor
//{
//    //    return [UIColor colorWithHue:210.0f / 360.0f
...
+ (UIColor *)zhc_messagesBubbleLightRedColor
{
    return [UIColor colorWithRed:(242/255.f) green:(77/255.f) blue:(77/255.f) alpha:255.f];
}
