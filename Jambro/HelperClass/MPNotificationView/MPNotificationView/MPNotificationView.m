...
//                                (id)[[UIColor colorWithWhite:0.9f  alpha:1.0f] CGColor]];
        ...
        [_contentView setBackgroundColor:[UIColor colorWithRed:15.0/255.0 green:77.0/255.0 blue:110.0/255.0 alpha:1.0]];
        ...
        UIView *bottomLine = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMinX(frame),
                                                                      ...
                                                                      CGRectGetWidth(frame),
                                                                      1.0f)];
        bottomLine.backgroundColor = [UIColor colorWithRed:15.0/255.0 green:77.0/255.0 blue:110.0/255.0 alpha:1.0];
